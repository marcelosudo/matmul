!pgf90 -acc -cuda -cudalib -Minfo=accel mainno4.f90 -o mainno4
...
program main
	...
	!print *, "a1 - a = ", leastsquares(a1, a, ni, nj)
      ...
      print *,"mainno4.f90 ", ni, " x ", nj, " ntimes = ", ntimes
      call cpu_time(t1)
	...
	!$acc end data
      call cpu_time(t2)
	  print  "(4(f12.5))", ((a(i,j) , j= 1, 4 ), i= 1, 4)
	  print *
	...
	print *
	print *, "e - a (real) = ", leastsquares(e, a, ni, nj)
