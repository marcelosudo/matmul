...
program main
	...
	real :: alpha = 0.25
    real(8), allocatable, dimension(:,:) :: a, a1, d, e
	real :: t1, t2, flops
	real(8) :: mx, my
    allocate(a(ni,nj),a1(ni,nj),d(ni,nj),e(ni,nj))
	a = 0.0d0
	d = 0.0d0
	a1 = 0.0d0
	e = 0.0d0
	...
	! print *, "a (max) = ", my
      ...
      print *,"mainn8.f90 ", ni, " x ", nj, " ntimes = ", ntimes
      call cpu_time(t1)
	do nt = 1, ntimes
	!$acc kernels
      do j = 2, nj-1
	...
	print *
	print *, "e - d = ", leastsquares(e, d, ni, nj, mx, my)
	 print *, "e (max) = ", mx
	 print *, "d (max) = ", my
